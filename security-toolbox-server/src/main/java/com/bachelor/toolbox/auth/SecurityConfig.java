        ...
        .authorizeHttpRequests(
            authorize ->
                authorize
                    ...
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/fingerprints/rules")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/fingerprints/rules/*")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/fingerprints/rules/*")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/recon/subdomain-dictionary/import")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/recon/subdomain-dictionary/update")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/recon/path-dictionary/import")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/recon/path-dictionary/update")
                    .hasRole("ADMIN")
